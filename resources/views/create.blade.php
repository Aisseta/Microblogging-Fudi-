        ...
        <div class="bg-white p-8 rounded-md shadow-md w-full md:w-2/3 lg:w-3/4 xl:w-1/2">
            ...
            <form  method="post" action="{{ route('store') }}" enctype="multipart/form-data">
                ...
                <div class="flex items-center justify-between">
                    <!-- Post button -->
                    <button type="submit"
                        class="flex justify-center items-center bg-blue-500 hover:bg-blue-600 focus:outline-none focus:shadow-outline-blue text-white py-2 px-4 rounded-md transition duration-300 gap-2" style="background-color:blueviolet;">
                         Submit Post
