...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-beige bg-center bg-white-100 dark:bg-dots-lighter dark:bg-white-900 selection:bg-red-500 selection:text-white">
            @if (Route::has('login'))
            ...
            height:90%;">
                ...
                <div>
                    ...
                    ">
                        ...
                        color:rgb(56,81,133);
                        font-weight:600;
                        font-size:18px;">Welcome <a href="{{ 'post'
                        }}">click here to start</a></span>
